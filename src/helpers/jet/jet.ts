...
import { Asset, AssetStore, CustomProgramError, IdlMetadata, Market, Reserve, TxnResponse, User } from './JetTypes';
...
const devnetIdl = "../../idl/devnet/idl.json"
const localnetIdl = "../../idl/localnet/idl.json"
const mainnetIdl = "../../idl/mainnet-idl/idl.json"

const jetIdl = JSON.stringify(localnetIdl);
